    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="jam_operasional" value="<?=$_POST['jam_operasional']?>"/>
            </div>
            <div class="form-group">
                <label>Contact Person</label>
                <input class="form-control" type="number" name="contact_person" value="<?=$_POST['contact_person']?>"/>
            </div>
            <div class="form-group">
