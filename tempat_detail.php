...
<div class="row">
    <div class="col-md-6">
        <p>
            <a href="?m=tempat_list" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Kembali</a>
    ...
    <div class="col-md-6">
        <h3 style="margin-top:30px">Galeri</h3>
        <div class="row">
            <?php
        ...
        <h3>Info Angkringan</h3>
        <p>Lokasi: <?=$row->lokasi?></p>
        <p>Jam Operasional: <?=$row->jam_operasional?></p>
        <p>Contact Person: <?=$row->contact_person?></p>
        <div>
        <?=$row->keterangan?>
        </div>
    </div>
