...
require_once'functions.php';
    ...
    if($mod=='tempat_tambah'){
        ...
        if($nama_tempat=='' || $gambar['name']=='' || $lat=='' || $lng=='' || $lokasi=='' || $jam_operasional=='')
            ...
            $db->query("INSERT INTO tb_tempat (nama_tempat, gambar, lat, lng, lokasi, keterangan, jam_operasional, contact_person) 
                    VALUES ('$nama_tempat', '$file_name', '$lat', '$lng', '$lokasi', '$keterangan', '$jam_operasional', '$contact_person')");                       
        ...
        if($nama_tempat=='' || $lat=='' || $lng=='' || $lokasi==''|| $jam_operasional=='')
            print_msg("Field bertanda * tidak boleh kosong!");
        else{           
            if($gambar['name']!=''){
            ...
            $db->query("UPDATE tb_tempat SET nama_tempat='$nama_tempat' $sql_gambar , lat='$lat', lng='$lng', lokasi='$lokasi', keterangan='$keterangan', jam_operasional='$jam_operasional', contact_person='$contact_person' WHERE id_tempat='$_GET[ID]'");
            redirect_js("index.php?m=tempat");
        }    
